...
def migrate_database():
    ...
    with engine.begin() as conn:
        ...
        if table_exists("reminders") and column_exists("reminders", "user_id"):
            ...
            conn.execute(text("ALTER TABLE reminders ADD COLUMN user_id UUID REFERENCES users(id)"))
        ...
        if table_exists("reminders") and column_exists("reminders", "reminder_type"):
            ...
            conn.execute(text("ALTER TABLE reminders ADD COLUMN reminder_type VARCHAR(20) DEFAULT 'scheduled'"))
        ...
        if table_exists("reminders") and column_exists("reminders", "message"):
            ...
            conn.execute(text("ALTER TABLE reminders ADD COLUMN message TEXT"))
